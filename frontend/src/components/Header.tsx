      ...
      <Container size="xl" h="100%">
        <Group justify="space-between" h="100%" align="center">
          ...
          <Group>
            ...
            <Button component={Link} href="/submission-history" variant="light" leftSection={<IconFolderCheck size={16} />}></Button>

            <Button component={Link} href="/submissions" variant="light" leftSection={<IconFilesFilled size={16} />}></Button>
